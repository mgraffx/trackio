...
How I run this
I am running this on Windows10 with the ubuntu subsystem
I use the subsystem for commands like git, rvm, bundle and rails
I used HeidiSql(free windows app) for DB creation and alterations as it allows me to CRUD all aspects of the schema.

Description:
Simple UI for storing and keeping track of tracking services used on a site, what parameters are relevant and descriptions for each.
