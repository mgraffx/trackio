...
## How I run this
  ...
  * I used HeidiSql(free windows app) for DB creation and alterations 
  >  as it allows me to CRUD all aspects of the schema.
...
## Accessing the Webapp:
  ...
  > In a browser, visit [webapp](localhost:3000)
